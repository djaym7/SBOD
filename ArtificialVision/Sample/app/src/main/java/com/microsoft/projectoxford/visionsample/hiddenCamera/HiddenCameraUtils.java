...
public final class HiddenCameraUtils {
     ...
     */
    @WorkerThread
    static Bitmap rotateBitmap(@NonNull Bitmap bitmap, @com.microsoft.projectoxford.visionsample.hiddenCamera.config.CameraRotation.SupportedRotation int rotation) {
    ...
    static boolean saveImageFromFile(@NonNull Bitmap bitmap,
                                     ...
                                     @com.microsoft.projectoxford.visionsample.hiddenCamera.config.CameraImageFormat.SupportedImageFormat int imageFormat) {
        ...
        switch (imageFormat) {
            case com.microsoft.projectoxford.visionsample.hiddenCamera.config.CameraImageFormat.FORMAT_JPEG:
                compressFormat = Bitmap.CompressFormat.JPEG;
                break;
            case com.microsoft.projectoxford.visionsample.hiddenCamera.config.CameraImageFormat.FORMAT_WEBP:
                compressFormat = Bitmap.CompressFormat.WEBP;
                break;
            case com.microsoft.projectoxford.visionsample.hiddenCamera.config.CameraImageFormat.FORMAT_PNG:
            default:
